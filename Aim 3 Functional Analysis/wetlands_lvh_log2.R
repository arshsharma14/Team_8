...
# Filter for only "Low" and "High" in cn_category
metadata <- metadata[metadata$cn_category %in% c("Low", "High"), ]
...
ggsave("wetlands_lvh_log2.png"
       , log2_fold_change
       , height=14, width =12)

ggsave("wetlands_lvh_log2_0.5.png"
       , log2_fold_change_0.5
       , height=14, width =12)
...
# save as R data 
save(pathways6, file = "Table/wetlands_low_v_high_table.RData")
