...
# Filter for only "Low-Soil" and "Low-Wetlands" in cn_category_per_dataset
metadata <- metadata[metadata$cn_category_per_dataset %in% c("Low-Soil", "Low-Wetlands"), ]
...
abundance_desc = abundance_desc[,-c(236:ncol(abundance_desc))] 
